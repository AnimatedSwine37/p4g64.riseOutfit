...
internal class Utils
{
    ...
    internal static void LogDebug(string message)
    {
        if (_config.DebugEnabled)
            _logger.WriteLine($"[Rise Outfit Changer] {message}");
    }
    ...
    {
        _logger.WriteLine($"[Rise Outfit Changer] {message}: {e.Message}", System.Drawing.Color.Red);
    }

    internal static void LogError(string message)
    {
        _logger.WriteLine($"[Rise Outfit Changer] {message}", System.Drawing.Color.Red);
    }
